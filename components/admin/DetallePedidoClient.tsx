        ...
        <div className="bg-orange-50 border-2 border-orange-400 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-orange-700 text-sm">
              El cliente debe enviar <strong>{pedido.total.toFixed(2)} €</strong> por Bizum al <strong>+34 604 825 305</strong>. Cambia el estado a &quot;Pagado&quot; cuando confirmes el cobro.
            </p>
          </div>
        </div>
      )}

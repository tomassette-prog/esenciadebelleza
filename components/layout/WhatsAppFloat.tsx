const WHATSAPP_URL = "https://wa.me/34604825305";
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ animation: "whatsapp-ping 1s ease-out 3" }}
      />

      {/* Button */}
      <span className="relative flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/25 transition-transform duration-200 group-hover:scale-110 md:w-14 md:h-14">
        <svg

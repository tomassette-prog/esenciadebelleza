    ...
    <main className="container-main py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          {/* Facturas — solo profesionales aprobados */}
          {esProfesional && b2bAprobado && (
            <div className="bg-white border border-neutral-100 p-6 mt-4">
              <h2 className="text-xs tracking-widest uppercase text-neutral-500 mb-4">
                Facturas
              </h2>
              <Link
                href="/cuenta/facturas"
                className="inline-flex items-center gap-2 text-sm text-neutral-900 hover:text-[#C4857A] transition-colors"
              >
